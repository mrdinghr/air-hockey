...
trajectory_index = 100  # choose which trajectory to test, current total 150 trajectories 2022.06.21
...
plt.scatter(data_set[trajectory_index][0, 0], data_set[trajectory_index][0, 1],)
plt.legend()
plt.show()
