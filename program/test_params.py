...
params = np.array([0.1615, 0.03585, 0.8216, 0.5727])  # table friction, table damping, table restitution, rim friction
trajectory_index = 103  # choose which trajectory to test, current total 150 trajectories 2022.06.21
